...
public class PermissionsPage extends AppCompatActivity {
    ...
    public void statslaunch(View view) {
        ...
        if (hasSMSPermission != PackageManager.PERMISSION_GRANTED && hasCallLogPermission != PackageManager.PERMISSION_GRANTED && hasSMSReceivePermission != PackageManager.PERMISSION_GRANTED && hasUsageStatsPermission != PackageManager.PERMISSION_GRANTED && hasFilesPermission != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(PermissionsPage.this, new String[] {Manifest.permission.READ_SMS, Manifest.permission.READ_CALL_LOG, Manifest.permission.RECEIVE_SMS, Manifest.permission.PACKAGE_USAGE_STATS, Manifest.permission.READ_EXTERNAL_STORAGE},
    ...
    public void toRegister(View view) {
        ...
        if (queryUsageStats.size() == 0) {
            Toast.makeText(PermissionsPage.this, "Please enable usage stats to use this app!", Toast.LENGTH_LONG).show();
        }
            ...
            Toast.makeText(PermissionsPage.this, "Please enable all permissions in order to use this app!", Toast.LENGTH_LONG).show();
            ActivityCompat.requestPermissions(PermissionsPage.this, new String[] {Manifest.permission.READ_SMS, Manifest.permission.READ_CALL_LOG, Manifest.permission.RECEIVE_SMS, Manifest.permission.PACKAGE_USAGE_STATS, Manifest.permission.READ_EXTERNAL_STORAGE},
                    REQUEST_CODE_ASK_PERMISSIONS);
