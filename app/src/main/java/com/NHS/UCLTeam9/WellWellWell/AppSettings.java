...
public class AppSettings extends AppCompatActivity {
       ...
       // Toolbar mToolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        input_postcode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new SimpleSearchDialogCompat(AppSettings.this, "Select your new postcode",
                        ...
                        new SearchResultListener<SampleSearchModel>() {
                            ...
                            public void onSelected(BaseSearchDialogCompat dialog,
                                ...
                                Toast.makeText(AppSettings.this, "postcode selected:"+item.getTitle(),
    ...
    public void mainlaunch(View view) {
        ...
        if (queryUsageStats.size() == 0) {
            Toast.makeText(AppSettings.this, "Please enable usage stats to use this app!", Toast.LENGTH_LONG).show();
        }
            ...
            Toast.makeText(AppSettings.this, "Please enable all permissions in order to use this app!", Toast.LENGTH_LONG).show();
            ActivityCompat.requestPermissions(AppSettings.this, new String[] {Manifest.permission.READ_SMS, Manifest.permission.READ_CALL_LOG, Manifest.permission.RECEIVE_SMS, Manifest.permission.PACKAGE_USAGE_STATS, Manifest.permission.READ_EXTERNAL_STORAGE},
